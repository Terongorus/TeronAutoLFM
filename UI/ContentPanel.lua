--=============================================================================
-- TeronAutoLFM: ContentPanel Factory
--=============================================================================
...
---   - rowTemplatePrefix: string - XML template prefix (e.g., "TeronAutoLFM_DungeonRow")
...
---   })
---
function TeronAutoLFM.UI.CreateContentPanel(config)
  if not config or not config.name or not config.rowTemplatePrefix or not config.createRowsFunc then
    TeronAutoLFM.Core.Utils.LogError("CreateContentPanel: Missing required config (name, rowTemplatePrefix, createRowsFunc)")
    return nil
  end
  ...
  function panel.OnShow(frame)
    TeronAutoLFM.UI.RowList.OnShowHandler(
      frame,
  ...
  if config.listeningEvent then
    ...
    TeronAutoLFM.Core.SafeRegisterInit("UI." .. config.name, function()
...
TeronAutoLFM.UI.ContentPanel = TeronAutoLFM.UI.CreateContentPanel
