...
TeronAutoLFM.Core.Constants.MESSAGE_PREVIEW_TEXT_WIDTH = 290
...
TeronAutoLFM.Core.Constants.MAX_GROUP_SIZE = 40
...
TeronAutoLFM.Core.Constants.MAX_PARTY_SIZE = 5
...
TeronAutoLFM.Core.Constants.MIN_BROADCAST_INTERVAL = 30
...
TeronAutoLFM.Core.Constants.MAX_BROADCAST_INTERVAL = 120
...
TeronAutoLFM.Core.Constants.DEFAULT_BROADCAST_INTERVAL = 60
...
TeronAutoLFM.Core.Constants.ROLES = {
  TANK = "TANK",
  HEAL = "HEAL",
  DPS = "DPS"
}
...
TeronAutoLFM.Core.Constants.VALID_ROLES = {
  TANK = true,
  HEAL = true,
  DPS = true
}
...
-- CHAT PREFIX
--=============================================================================
-- CHAT_PREFIX: Colored "[TeronAutoLFM]" prefix added to all broadcast messages
-- Provides visual identification in chat and helps distinguish addon messages
TeronAutoLFM.Core.Constants.CHAT_PREFIX = "|cff808080[|r|cffffffffTeronAuto|r|cff0070ddL|r|cffffffffF|r|cffff0000M|r|cff808080]|r"
...
TeronAutoLFM.Core.Constants.GREEN_DIFFICULTY_THRESHOLD_BY_LEVEL_BRACKET = {
...
TeronAutoLFM.Core.Constants.DIFFICULTY_RED_THRESHOLD = 5
...
TeronAutoLFM.Core.Constants.DIFFICULTY_ORANGE_THRESHOLD = 3
...
TeronAutoLFM.Core.Constants.DIFFICULTY_YELLOW_THRESHOLD = -2
...
TeronAutoLFM.Core.Constants.COLORS = {
...
-- DUNGEONS DATABASE
--=============================================================================
TeronAutoLFM.Core.Constants.DUNGEONS = {
  ...
  {name = "Maraudon Orange", tag = "Mara Orange", levelMin = 43, levelMax = 51},
  {name = "Maraudon Purple", tag = "Mara Purple", levelMin = 45, levelMax = 52},
  {name = "Maraudon Princess", tag = "Mara Princess", levelMin = 46, levelMax = 54},
  ...
  {name = "Dire Maul East", tag = "DM E", levelMin = 55, levelMax = 60},
  ...
  {name = "Caverns of Time. Black Morass", tag = "BM", levelMin = 60, levelMax = 60}
}

--=============================================================================
-- RAIDS DATABASE
--=============================================================================
TeronAutoLFM.Core.Constants.RAIDS = {
...
TeronAutoLFM.Core.Constants.DEBUG_LINE_HEIGHT = 14
...
TeronAutoLFM.Core.Constants.DEBUG_BUFFER_MAX_LINES = 500
...
TeronAutoLFM.Core.Constants.BROADCASTER_TIMER_INTERVAL = 1
...
TeronAutoLFM.Core.Constants.SCROLL_PADDING = 10
...
TeronAutoLFM.Core.Constants.SOUND_PATH = "Interface\\AddOns\\TeronAutoLFM\\UI\\Sounds\\"
...
TeronAutoLFM.Core.Constants.DUNGEONS_BY_NAME = {}
...
TeronAutoLFM.Core.Constants.RAIDS_BY_NAME = {}
...
TeronAutoLFM.Core.Constants.DUNGEONS_COUNT = 0  -- Updated by BuildLookupTables()
TeronAutoLFM.Core.Constants.RAIDS_COUNT = 0     -- Updated by BuildLookupTables()

--=============================================================================
-- BROADCAST RETRY CONSTANTS
--=============================================================================
-- MAX_BROADCAST_RETRIES: Maximum number of retry attempts for failed broadcasts
TeronAutoLFM.Core.Constants.MAX_BROADCAST_RETRIES = 2

-- BROADCAST_RETRY_DELAY: Delay in seconds between retry attempts
TeronAutoLFM.Core.Constants.BROADCAST_RETRY_DELAY = 1
...
TeronAutoLFM.Core.Constants.INVITE_COOLDOWN = 5
...
TeronAutoLFM.Core.Constants.INVITE_COOLDOWN_CLEANUP_INTERVAL = 60
...
TeronAutoLFM.Core.Constants.WORD_BREAK_THRESHOLD = 0.7
...
TeronAutoLFM.Core.Constants.PRESET_DEFAULTS = {
  dungeonNames = {},
  raidName = nil,
  raidSize = 40,
  roles = {},
...
TeronAutoLFM.Core.Constants.PRESET_RAID_SIZE_MIN = 10

-- PRESET_RAID_SIZE_MAX: Maximum valid raid size for presets
TeronAutoLFM.Core.Constants.PRESET_RAID_SIZE_MAX = 40

-- PRESET_GROUP_SIZE_MIN: Minimum valid custom group size
TeronAutoLFM.Core.Constants.PRESET_GROUP_SIZE_MIN = 1

-- PRESET_GROUP_SIZE_MAX: Maximum valid custom group size
TeronAutoLFM.Core.Constants.PRESET_GROUP_SIZE_MAX = 40
